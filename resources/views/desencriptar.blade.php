...
<body>
    <section>
        <div class="conteinder">
            <div class="row">
                <form action="{{ route('desencriptarRoute') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Digita texto encriptado</label>
                      <input type="text" class="form-control" name="texto" aria-describedby="">
                      <label for="exampleInputEmail1" class="form-label">Digita la llave para deseencriptar</label>
